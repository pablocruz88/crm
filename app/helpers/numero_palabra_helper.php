<?php
/*
File Name    : numero_palabra_helper.php
Date Created : 2018-09-04
Author       : Julián Zepeda
Description  : This is the helper that have the function to convert numbers to words in spanish
...
*/
    ...
    function convertir($number, $moneda = '', $centimos = '', $forzarCentimos = false)
    {
        ...
        if(empty($decimales)){
            ...
            $valor_convertido = $converted . strtoupper($moneda) . ' PUNTO ' . $decimales . ' ' . strtoupper($centimos);
        }
